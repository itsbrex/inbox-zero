      ...
      pollIntervalRef.current = setInterval(async () => {
        try {
          ...
          if (data.status === "complete") {
            ...
            toastSuccess({
              description: data.message || "Account linked successfully!",
            });
            setTimeout(() => {
              setOpen(false);
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Device Code Authentication</DialogTitle>
          <DialogDescription>
            Sign in using a device code for CLI or headless environments.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          {(flowState === "polling" || flowState === "complete") &&
            deviceCode && (
              <div className="space-y-4">
